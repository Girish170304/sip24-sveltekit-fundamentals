...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input name="username" id="username" type="text" class="bg-blue-100 border border-blue-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" />
    </div>
    <div class="mb-3">
        <label for="content" class="block mb-2 text-sm font-medium text-gray-900">Content</label>
        <textarea name="content" id="content" class="bg-blue-100 border border-blue-300 text-gray-900 text-sm rounded-lg block w-full p-2.5"></textarea>
    </div>
    
    <button type="submit" class="mt-4 text-white bg-blue-500 hover:bg-blue-900 font-medium rounded-lg text-sm px-5 py-2.5">Post</button>
</form>
